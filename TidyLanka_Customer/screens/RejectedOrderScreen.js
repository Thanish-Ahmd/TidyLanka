...
import OrderRowRejected from '../components/OrderRowRejected';
...
export default function RejectedOrderScreen() {
    ...
    const getOrder =async  () =>{
        ...
        await
        axios
        .get(`http://${window.ip}:5000/order/rejectedCustomers/${id}`).then((res)=>{
            setOrders(res.data)
        ...
        <>
            ...
            <ScrollView  >
                ...
                <View
                    ...
                    <View className="px-5">
                        <Text className="text-3xl font-bold">Rejected Orders</Text>
