                    ...
                    <View className="flex-row pl-3 justify-between items-center">
                        ...
                        <View className="justify-between items-center mx-5 rounded-full p-4 py-3 ">
                            <View className="p-2 px-4 rounded-full">
                                <Text className="text-gray-700 text-lg font-bold">Order Status
                                </Text>
                                <Text>
                                {item.status}
                                </Text>
                            ...
                            <View>
                                {item.status == "In the laundry" ?  <TouchableOpacity style={style.deleteBtn} onPress={()=>{
                               axios 
                               .put(`http://${window.ip}:5000/order/completeOrder/${item._id}`).then(()=>{
