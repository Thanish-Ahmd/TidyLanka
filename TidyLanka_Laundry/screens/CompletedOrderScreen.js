...
import OrderRowCompleted from '../components/OrderRowCompleted';
...
export default function CurrentOrderScreen() {
    ...
    const getOrder =async  () =>{
        ...
        await
        axios
        .get(`http://${window.ip}:5000/order/laundryCompleted/${id}`).then((res)=>{
            setOrders(res.data)
...
{orders.map((order)=>(
    <OrderRowCompleted item={order} />
                        ...
                        //     axios 
                        //     .put(`http://${window.ip}:5000/order/deliverOrder/${order._id}`).then(()=>{
                        ...
                        //     })
                        // }}>
                        //     <Text style={style.deleteText}>Deliver</Text>
                        // </TouchableOpacity>
                        // </View>
                ))}
    </ScrollView>
