import { View, Text, Image, Dimensions, Platform, StyleSheet, TouchableOpacity } from 'react-native';
...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.headerText}>Tidy Lanka - Laundry Owner</Text>
      <StatusBar />
      ...
      <SafeAreaView className={ios ? '-mb-8' : ''}>
        ...
        <View style={styles.ordersContainer}>
          ...
          {/* <View style={styles.editPricingContainer}>
        <TouchableOpacity style={styles.touchableEditing}>
          <Text style={styles.editingText}>Set Pricing</Text>
        </TouchableOpacity>
