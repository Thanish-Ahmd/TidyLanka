...
export default function CurrentOrderScreen() {
    ...
    const getOrder =async  () =>{
        ...
        await
        axios
        .get(`http://${window.ip}:5000/order/laundryPending/${id}`).then((res)=>{
            setOrders(res.data)
...
{orders.map((order)=>(
    <OrderRow item={order} />
                        ...
                        //     axios 
                        //     .put(`http://${window.ip}:5000/order/acceptOrder/${order._id}`).then(()=>{
                        ...
                        //     axios 
                        //     .put(`http://${window.ip}:5000/order/rejectOrder/${order._id}`).then(()=>{
